...
// TODO: test
export const isOptOutImportPresent = ({ script, moduleScript }) => {
    const scriptSourceFile = codeToSourceFile(script);
    if (isOptOutImportPresentOriginal(scriptSourceFile))
        return true;
    const moduleScriptSourceFile = codeToSourceFile(moduleScript);
    if (isOptOutImportPresentOriginal(moduleScriptSourceFile))
        return true;
    return false;
};
// ------------------------------------------------------------------------------------------------
// TODO: test
export const isSdkImportPresent = ({ script, moduleScript }) => {
    const scriptSourceFile = codeToSourceFile(script);
    if (isSdkImportPresentOriginal(scriptSourceFile))
        return true;
    const moduleScriptSourceFile = codeToSourceFile(moduleScript);
    if (isSdkImportPresentOriginal(moduleScriptSourceFile))
        return true;
    return false;
};
