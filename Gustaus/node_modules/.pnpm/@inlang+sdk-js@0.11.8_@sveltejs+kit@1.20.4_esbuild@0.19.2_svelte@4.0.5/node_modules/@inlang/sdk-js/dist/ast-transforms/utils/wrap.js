import { Node, CallExpression, SyntaxKind, SourceFile, VariableDeclaration, FunctionDeclaration, ExportSpecifier, ArrowFunction, FunctionExpression, ParenthesizedExpression, SatisfiesExpression, } from "ts-morph";
...
const findFunction = (node) => {
    if (ArrowFunction.isArrowFunction(node) || FunctionExpression.isFunctionExpression(node))
        return node;
    if (ParenthesizedExpression.isParenthesizedExpression(node) ||
